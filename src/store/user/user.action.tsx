...
export const signUpSuccess = (user: any, additionalDetails: unknown) =>
  createAction(USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user, additionalDetails })

export const signUpFailed = (error: Error) => createAction(USER_ACTION_TYPES.SIGN_UP_FAILED, error)
