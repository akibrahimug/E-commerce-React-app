...
import { addItemToCart, removeCartItem, removeWithoutDecrement } from '../../store/cart/cart.action'
...
function CheckoutItem({ cartItem }) {
  ...
  const handleRemoveFromCart = () => dispatch(removeCartItem(cartItems, cartItem))

  // handleClear cartItem
  const handleClearCartItem = () => dispatch(removeWithoutDecrement(cartItems, cartItem))
